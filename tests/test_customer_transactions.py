...
from routers.customers import _transaction_summary
...
def test_get_customer_transactions_not_found(client):
    ...
    with pytest.MonkeyPatch.context() as patcher:
        ...
        response = client.get("/customers/999/transactions")
...
def test_get_customer_transactions_returns_customer_and_transactions(client):
    session = MagicMock()
