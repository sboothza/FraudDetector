...
Seed creates a user **`stephen`** with password **`stephen`** which can be used to login.
...
1. Open http://localhost:5601 — the **Fraud Detector Logs** dashboard is the default page
